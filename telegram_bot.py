...
def send_welcome(message):
    help_text = (
        ...
        "Просто пиши мне обычным языком. Я сам пойму, когда ты просто общаешься, а когда просишь что-то сделать на сервере.\n\n"
        "**Команды:**\n"
        "🔹 `/status` — Статус сервера (диск, RAM, uptime)\n"
        "🔹 `/cmd <команда>` — Выполнить bash-команду\n"
